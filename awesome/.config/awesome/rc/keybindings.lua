...
globalkeys = gears.table.join(
    ...
    -- Media controls
    awful.key({ modkey }, "F2", function () awful.spawn("playerctl volume .1-") end),
    awful.key({ modkey }, "F3", function () awful.spawn("playerctl volume .1+") end),
    awful.key({ modkey }, "F5", function () awful.spawn("playerctl stop") end),
