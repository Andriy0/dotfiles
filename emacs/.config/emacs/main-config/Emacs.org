...
** Dashboard
An extensible [[https://github.com/emacs-dashboard/emacs-dashboard][emacs startup screen]] showing you what’s most important.
...
** Graphviz Mode
Emacs [[https://github.com/ppareit/graphviz-dot-mode][package]] for working with [[https://graphviz.org/][Graphviz]] DOT-format files.

The features of this package help you to create .dot or .gv files containing syntax compatible with Graphviz and use Graphviz to convert these files to diagrams. [[https://graphviz.org/][Graphviz]] is a set of open source graph visualization tools created by AT&T Labs Research. A graph is a way of representing information as a network of connected nodes (shapes) and edges (lines).
